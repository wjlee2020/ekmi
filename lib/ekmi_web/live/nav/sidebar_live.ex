defmodule EkmiWeb.Nav.SidebarLive do
  ...
  def render(assigns) do
    ~H"""
    <div class="h-full w-64 py-8 px-4 fixed left-0 top-0 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <.link patch={~p"/budgets"} class="flex items-center pl-2.5 mb-5">
