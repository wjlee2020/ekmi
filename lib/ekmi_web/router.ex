defmodule EkmiWeb.Router do
  use EkmiWeb, :router

  import EkmiWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {EkmiWeb.Layouts, :root}
  ...
  # scope "/api", EkmiWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:ekmi, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EkmiWeb.Telemetry
